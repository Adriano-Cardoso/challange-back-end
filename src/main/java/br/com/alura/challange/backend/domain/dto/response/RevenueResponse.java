...
public class RevenueResponse {
	...
	@ApiModelProperty(position = 2, value = "Description", name = "descrição da receita", dataType = "String", example = "Compras Mes")
	private String description;

	@ApiModelProperty(position = 3, value = "value", name = "valor da receita", dataType = "String", example = "800.00")
